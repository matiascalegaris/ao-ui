...
export const MapInfoSlice = createSlice({
  ...
  reducers: {
    ...
    setClanSignal: (state, action) => {
      state.clanSignal = action.payload
    },
...
export const { setMapInfo, setCoordinates, setInterestPoints, updateGroupMarker, setClanSignal } = MapInfoSlice.actions
...
export const selectClanSignal = (state) => state.mapInfo.clanSignal
